...
pivot_comparison AS (
    SELECT 
        destination_country,
        MAX(CASE WHEN year = 2021 THEN total_visitors END) AS visitors_2021,
...
SELECT 
    ...
    visitors_2021,
    visitors_2024,
    (visitors_2024 - visitors_2021) AS absolute_growth,
    ROUND(
        ((visitors_2024 - visitors_2021) * 100.0) / NULLIF(visitors_2021, 0), 
        2
    ) AS percent_growth
FROM pivot_comparison
WHERE visitors_2021 IS NOT NULL 
